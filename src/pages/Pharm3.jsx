...
const Pharm3 = () => {
  ...
  <div className="absolute top-[545px] left-[964px] font-medium opacity-[0.7]">
  Attach Document
</div>
<input className="absolute top-[583.5px] left-[963.5px]  p-2 rounded-[3.56px] bg-white box-border w-[361px] h-11 overflow-hidden text-mini text-darkslategray border-[1px] border-solid border-black"  type="file"
id="image"
accept="image/*">
  </input>  <div
  className="absolute top-[588px] left-[1284px] w-[35px] h-[35px] overflow-hidden object-cover opacity-[0.5]"
 
><Icon icon="mdi:upload" width="30" height="30" /></div>
   
  </div></Form></Formik></div>
  )
}

export default Pharm3