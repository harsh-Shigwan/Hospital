...
const Row3 = () => {
  ...
  return (
   <>
      <Patient/>
      <div>
        <div className='w-[1356px] h-[50px] left-[92px] rounded-[5px] border-1 border-blue-400
        ml-[10px] md:ml-[90px] mt-[10px] md:mt-[17px]
        pt-[8px]
       
        '>
          <ul>
            <Link className=" h-[27px] w-[65px]
             px-[4px] py-[10px]
            text-[15px] sm:text-[22px]
            hover:bg-blue-600
            hover:text-white
            
            ml-[10px] md:ml-[120px] mt-[10px] md:mt-[10px]
           
            font-bold line-height-[27px] text-[#135A95] text-center
             text " to=''>LAMA</Link>
            <Link className="text-[15px] sm:text-[22px] h-[27px] w-[65px]
            hover:bg-blue-600
            hover:text-white
            px-[7px] py-[10px]
            ml-[10px] md:ml-[120px] mt-[10px] md:mt-[10px]
            font-bold line-height-[27px] text-[#135A95] text-center
             text " to=''>Transferred</Link>
            <Link className="text-[15px] sm:text-[22px] h-[27px] w-[65px]
            ml-[10px] md:ml-[130px] mt-[10px] md:mt-[10px]
            hover:bg-blue-600
            hover:text-white
            px-[7px] py-[10px]
            font-bold line-height-[27px] text-[#135A95] text-center
             text " to=''>Discharge</Link>
            <Link className="text-[15px] sm:text-[22px] h-[27px] w-[65px]
            ml-[10px] md:ml-[120px] mt-[10px] md:mt-[10px]
            px-[7px] py-[10px]
            hover:bg-blue-600
        ...
        <div className='flex'>
      <div className='inline-flex md:inline-flex mt-[20px] md:mt-[15px]
      pl-[9px] md:pl-[100px]
      ml-[9px] md:ml-[129px]
      pr-[9px] md:pr-[59px]
      ...
      rounded-[10px]    
      w-[600px] sm:w-[1550px]  
      pt-[20px]   pb-30 text-center bg-white shadow-2xl  hover:shadow-inner   ' >
     ...
     <div className='flex'>
         ...
         <div   onClick={handleprint} className='flex bg-[#135A95]
         h-[35px]
         w-[105px]
         ml-[19px] md:ml-[339px]
         mt-[20px] md:mt-[10px]
